...
title_frame = Frame(root, bd=8, bg="hot pink", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="Perfume Shop Management System",
                    font=("times new roman", 20, "bold"),bg = "hot pink", fg="black", pady=5)
title_label.pack()


customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),
                            bd=8, bg="hot pink", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", 
                    font=("arial", 15, "bold"),bg = "hot pink", fg="black")
...
menu_frame = Frame(root,bd=8, bg="hot pink", relief=GROOVE)
menu_frame.place(x=0,y=125,height=530,width=650)

menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "hot pink", fg="black", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="hot pink",pady=10)
menu_category_frame.pack(fill="x")

combo_lable = Label(menu_category_frame,text="Select Type", 
                    font=("arial", 12, "bold"),bg = "hot pink", fg="black")
...
item_frame = Frame(root,bd=8, bg="hot pink", relief=GROOVE)
item_frame.place(x=650,y=120,height=200,width=650)

item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "hot pink", fg="black")
item_title_label.pack(side=TOP,fill="x")

item_frame2 = Frame(item_frame, bg="hot pink")
...
#stock_button = ttk.Button(item_frame2, text="stock")
#stock_button.grid(row=1,column=2,padx=40,pady=15)
item_frame3 = Frame(item_frame, bg="hot pink")
...
clear_button = ttk.Button(item_frame3, text="Clear",
                        width=5,command=clear_button_operation)
clear_button.grid(row=0,column=4,padx=30,pady=30)


order_frame = Frame(root,bd=8, bg="pink", relief=GROOVE)
order_frame.place(x=650,y=310,height=300,width=650)
...
total_price_label = Label(order_frame, text="Total Price", 
                    font=("arial", 12, "bold"),bg = "pink", fg="blue")
